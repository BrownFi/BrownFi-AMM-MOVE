...
const main = async () => {
	try {
		...
		const keypair = Ed25519Keypair.fromSecretKey(
			fromHEX(
				"b89dd1d83371e777f543e336c04450d5c8f94b9d3dac6ce6cea85af3d12cc3c2"
			)
		);

		console.log(
			"🚀 ~ file: add-lp.ts:27 ~ main ~ keypair:",
		...
		const coinBType =
			"0x23a21e3ce259d81cc21a4e4e4e0dad7be73855f2c3a73a1ad7fea1e1d248fa94::mock_token::MOCK_TOKEN";
		...
		console.log(
			"🚀 ~ file: add-lp.ts:63 ~ main ~ coinObjectAId:",
			coinObjectAId
		);

		console.log(
			"🚀 ~ file: add-lp.ts:71 ~ main ~ coinObjectBId:",
			coinObjectBId
		);
		// bcs.bytes(coinAType)
		...
		const rest = txb.moveCall({
			...
			arguments: [
				txb.object(
					"0x79ea07ba61d03cd009d72ffbafde572d09d33de6408696e638ea95bceee18a56"
				),
